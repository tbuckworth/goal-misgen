...
python3.8 /vol/bitbucket/${USER}/goal-misgen/train.py --exp_name maze1 --env_name maze_aisc --num_levels 500 --distribution_mode hard --param_name hard-500 --num_timesteps 200000000 --num_checkpoints 5 --seed 100 --use_wandb
...
#python3.8 /vol/bitbucket/${USER}/goal-misgen/run_train_dict.py
